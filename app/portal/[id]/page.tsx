...
import { Calendar, Activity, TrendingUp, Sparkles } from "lucide-react";
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6 sm:mb-8">
        <div>
          <p className="text-xs uppercase tracking-[0.18em] mb-1 text-inkFaint">Portal da família</p>
          <h2 className="text-xl sm:text-2xl font-display font-semibold text-ink">Como {paciente.name.split(" ")[0]} está indo</h2>
        </div>
        <Avatar nome={paciente.name} size={38} />
      </div>

      <div
        className="rounded-2xl p-5 sm:p-7 mb-6 text-white relative overflow-hidden"
