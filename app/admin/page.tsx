...
export default async function AdminPage() {
  ...
  const [
    ...
    prisma.professionalInvite.findMany({
    ...
    <div className="rounded-2xl p-5 sm:p-8 bg-bg">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-8">
        {[
          ...
          {
            label: "Familiares ativos",
            valor: totalFamiliaresAtivos,
            icon: ShieldCheck,
          },
        ].map((s, i) => (
          <div
            key={i}
            className="relative rounded-xl p-4 sm:p-5 bg-white border border-line overflow-hidden"
          >
            <span
            ...
            <p className="text-[11px] sm:text-xs uppercase tracking-wide mt-1.5 text-inkFaint">
              {s.label}
            </p>
          </div>
        ))}
      ...
      {profissionais.length === 0 ? (
        ...
        <div className="space-y-2.5 mb-8">
          {profissionais.map((p) => (
            <div
              key={p.id}
              className="flex items-center gap-3 rounded-xl p-4 bg-white border border-line"
            >
              ...
              >
                <div className="flex items-center gap-3 p-4">
                  ...
                  <span
                    ...
                    style={{ background: "#F1E2C2", color: "#B9812F" }}
                  >
                    Pendente
                  </span>
